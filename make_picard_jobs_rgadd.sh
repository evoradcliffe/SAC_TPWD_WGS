...
for s in ${SAMPLES[@]}
do
    echo "java -jar /home/wrad07/moranlab/shared/darters/Ready_To_Align/symIL_Ecaer_reads/picard.jar AddOrReplaceReadGroups TMP_DIR=/tmp INPUT=/home/wrad07/moranlab/shared/SAC_TPWD/Comal/Hypo_alignment/raw_bams/${s}_raw.bam OUTPUT=/home/wrad07/moranlab/shared/SAC_TPWD/Comal/Hypo_alignment/raw_bams/${s}_rgadd.bam RGID=${s} RGLB=${s} RGPL="Illumina" RGPU=${s} RGSM=${s} CREATE_INDEX="true""
done
